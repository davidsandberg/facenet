...
def inference(images, pool_type, use_lrn, keep_probability, phase_train=True):
  ...
  affn1 = facenet.affine(resh1, 896, 2048)
  affn1_dropout = tf.nn.dropout(affn1, keep_probability)
  affn2 = facenet.affine(affn1_dropout, 2048, 2048)
  affn2_dropout = tf.nn.dropout(affn2, keep_probability)
  affn3 = facenet.affine(affn2_dropout, 2048, 128)
  norm = tf.nn.l2_normalize(affn3, 1, 1e-10, name='embeddings')
