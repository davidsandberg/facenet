...
def main(argv=None):  # pylint: disable=unused-argument
    ...
    def model(data, train=False, m=1, lmbd=1.0):
        ...
        if train:
            logits = facenet.angular_softmax_loss_decomp(fc2_weights, hidden, train_labels_node, m, lmbd)
        else:
            logits = tf.matmul(hidden, fc2_weights)
